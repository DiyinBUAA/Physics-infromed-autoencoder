...
def get_optimizer(model,args,params):
...
def load_data(args):
    if 'CALCE' in args.source_dir:
        if args.method_type=='lstm':
            from dataloader.CALCE_Phy_loader import load_single_domain_data_lstm as load_single_domain_data
        else:
            from dataloader.CALCE_Phy_loader import load_single_domain_data
